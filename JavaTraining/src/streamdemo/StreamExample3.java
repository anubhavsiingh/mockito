...
/*The Collectors class in Java 8 
provides methods for grouping and partitioning
 data stored in collections.
Grouping permits you to organize data that shares a common
 field value, e.g. department. Partitioning allows you to divide
  the data into two categories, or partitions.
...
public class StreamExample3 {
	...
	public static void main(String[] args) {
		...
		value.forEach(i->System.out.println(i.getName()+" "+i.getPrice()+" "+i.getType()));
		});
